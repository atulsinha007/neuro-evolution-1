...
def mymutate_src(ind1):
	...
	new_ind = ind1.do_mutation(rate_conn_weight = 1, rate_conn_itself = 1, rate_node = 1, weight_factor = 1, inputdim = indim, outputdim = outdim, max_hidden_unit=  n_hidden, rng = random)
	return ind1
