...
def minimize_src(individual):
    ...
    #sensitivity, specification = sens_and_spec(outputarr, network_obj_src.resty)
    sensitivity, precision = sens_and_prec(outputarr, network_obj_src.resty)
